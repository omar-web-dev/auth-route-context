           ...
           <div className=" ">
                <nav className="relative p-4 flex justify-between items-center bg-white">
                    ...
                    <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                        <li><Link to='home' className="focus:text-md text-gray-500 focus:text-blue-500 hover:text-blue-400 font-semibold" >Home</Link></li>
                        ...
                        <li><Link to='experience' className="focus:text-md text-gray-500 focus:text-blue-500 hover:text-blue-400 font-semibold" >Experience</Link></li>
                        <li className="text-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                            </svg>
                        </li>
                        <li><Link to='/about' className="focus:text-md text-gray-500 focus:text-blue-500 hover:text-blue-400 font-semibold" >About Us</Link></li>
                        <li className="text-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                            </svg>
