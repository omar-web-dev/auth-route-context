            ...
            <div className="mx-auto mt-20 flex  w-[350px] flex-col border-2 bg-white text-black shadow-xl">
                ...
                <form onSubmit={handelSingIn}>
                    <div className="flex flex-col items-center">
                        <input id='email' className="my-2 w-72 border p-2" type="email" placeholder="Username" />
                        <input id='password' className="my-2 w-72 border p-2" type="password" placeholder="Password" />
                    </div>
                    <div className="my-2 flex justify-center">
                        <button id='submit' className="w-72 border bg-[#0DE6AC] p-2 font-sans">Login</button>
                    </div>
                    <div className="mx-7 my-3 flex justify-between text-sm font-semibold">
                        <div><h1>Forget Password</h1></div>
                        <div><button className="underline underline-offset-2">Signup</button></div>
                    </div>
                    <div className='mx-7'>
