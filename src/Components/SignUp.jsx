            ...
            <div className="mx-auto mt-20 flex  w-[350px] flex-col border-2 bg-white text-black shadow-xl">
                ...
                <form onSubmit={handelSubmit}>
                    <div className="flex flex-col items-center">
                        <input className="my-2 w-72 border p-2" id='name' name='name' type="text" placeholder="Username" />
                        <input className="my-2 w-72 border p-2" id='email' name='email' type="email" placeholder="Usermail" />
                        <input className="my-2 w-72 border p-2" id='password' name='password' type="password" placeholder="Password" />
                    </div>
                    ...
                    <div className="mx-7 my-3 flex justify-between text-sm font-semibold">
                        ...
                        <div><button className="underline underline-offset-2">Sign in</button></div>
                    </div>
                    <div className='mx-7'>
